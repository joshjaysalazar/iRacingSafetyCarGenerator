...
class Generator:
    ...
    def _check_random(self):
        ...
        try:
            ...
            logging.exception("An error occurred checking random safety car")
            raise e
    ...
    def _check_stopped(self):
        ...
        try:
            ...
            logging.exception("An error occurred checking stopped cars")
            raise e
    ...
    def _check_off_track(self):
        ...
        try:
            ...
            logging.exception("An error occurred checking off track cars")
            raise e
    ...
    def _get_driver_number(self, id):
        ...
        try:
            ...
            logging.exception("An error occurred getting driver number")
            raise e
    ...
    def _loop(self):
        ...
        while self.total_sc_events < max_events:
            ...
            try:
                ...
                logging.exception("An error occurred checking time")
                raise e
    ...
    def _send_pacelaps(self):
        ...
        try:
            ...
            logging.exception("An error occurred sending pacelaps command")
            raise e
    ...
    def _send_wave_arounds(self):
        ...
        try:
            ...
            logging.exception("An error occurred sending wave around commands")
            raise e
    ...
    def _start_safety_car(self, message=""):
        ...
        try:
            ...
            logging.exception("An error occurred starting the safety car")
            raise e
    ...
    def _wait_for_green_flag(self):
        ...
        try:
            ...
            logging.exception("An error occurred waiting for the green flag")
            raise e
    ...
    def run(self):
        ...
        try:
            ...
            logging.exception("An error occurred connecting to iRacing")
            raise e
        ...
        try:
            ...
            logging.exception("An error occurred creating the Drivers object")
            raise e
