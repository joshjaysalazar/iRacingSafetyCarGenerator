...
class App(tk.Tk):
    ...
    def _create_widgets(self):
        ...
        self.spn_proximity_dist.insert(0, str(self.settings.proximity_yellows_distance))
    ...
    def _save_settings(self):
        ...
        self.settings.random = bool(random)
        self.settings.random_max_occ = int(random_max_occ)
        self.settings.random_prob = float(random_prob)
        self.settings.random_message = str(random_message)
        self.settings.stopped = bool(stopped)
        self.settings.stopped_min = int(stopped_min)
        self.settings.stopped_message = str(stopped_message)
        self.settings.start_multi_val = float(start_multi_val)
        self.settings.start_multi_time = float(start_multi_time)
        self.settings.off = bool(off)
        self.settings.off_min = int(off_min)
        self.settings.off_message = str(off_message)
        self.settings.max_safety_cars = int(max_safety_cars)
        self.settings.start_minute = float(start_minute)
        self.settings.end_minute = float(end_minute)
        self.settings.min_time_between = float(min_time_between)
        self.settings.laps_under_sc = int(laps_under_sc)
        self.settings.wave_arounds = bool(wave_arounds)
        self.settings.laps_before_wave_arounds = int(laps_before_wave_arounds)
        self.settings.proximity_yellows = bool(proximity_yellows)
        self.settings.proximity_yellows_distance = float(proximity_yellows_distance)
