...
class MockDrivers:
    def __init__(self, current, previous):
        ...
        self.current_drivers.append({"track_loc": TrkLoc.not_in_world, "laps_completed": 0, "lap_distance": 0.0})
        self.previous_drivers.append({"track_loc": TrkLoc.not_in_world, "laps_completed": 0, "lap_distance": 0.0})
...
def test_detect_stopped_driver():
    ...
    stopped = detector.detect(drivers)
